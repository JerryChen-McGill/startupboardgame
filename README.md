...
一款把用户、传播、痛点与产品连接成完整创业项目的合作桌游原型。

玩家从用户、传播、痛点和产品四类卡牌中选择方案，通过限时讨论、放置、连线和解释，把四张 3:4 卡牌按“用户、传播、痛点、产品”的顺序拼成 2×2 项目面板。只检查四条相邻关系，不检查用户—产品、痛点—传播两个对角组合。
...
- 只允许用户—痛点、用户—传播、痛点—产品、产品—传播四种相邻关系。
